...
public class ModItems {
    ...
    public static final Item POLYP_RESIN = registerItem("polyp_resin", new Item(new Item.Properties()));
    public static final Item SYMBIOTIC_ENZYME = registerItem("symbiotic_enzyme", new Item(new Item.Properties()));
